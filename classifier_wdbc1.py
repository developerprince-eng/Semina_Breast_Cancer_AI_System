...
def main():
    ...
    input_x, features_train, features_test, label_train, label_test = create_dataset.__obtain_data__('input/breast-cancer-wisconsin.data', number_features=9, number_labels=1)
    ...
    metric1 = classifer.kr_train_DNN_Seq_01(9, features_train, features_test, label_train,  label_test, batch_size=100)
